    ...
    return {
        ...
        link: function($scope, elem, attrs) {
            ...
            $scope.processResults = function(responseData, str) {
                if (responseData && responseData.length > 0) {
                    ...
                    for (var i = 0; i < responseData.length; i++) {
                        ...
                        if ($scope.imageField) {
                        	// MOBILMAN 
                        	if (responseData[i][$scope.imageField] == '0' || responseData[i][$scope.imageField] == '')
                        	{
                        		image = imageUri + 'defaultavatar.png';
                        	}
                        	else
                            {
            ...
            $scope.selectResult = function(result) {
                ...
                $scope.selectedObject = result.originalObject; // MOBILMAN
                $scope.showDropdown = false;
                $scope.results = [];
                //$scope.$apply();
            }
